 ...
 * @author mcangel
 */
public class NormalTableModel extends AbstractTableModel implements Serializable
{
//
// Instance Variables
//
...
//
	 ...
	 * @see #setValueAt
	 */
	public NormalTableModel(int rowCount, int columnCount)
	{
	 ...
	 * @see #setValueAt
	 */
	public NormalTableModel(Vector columnNames, int rowCount)
	{
	 ...
	 * @see #setDataVector
	 */
	public NormalTableModel(Object[][] data, Object[] columnNames)
	{
		setDataVector(data, columnNames);
	}
...
//
	...
	/**
	 * This method retrieveі the columnIdentifiers
